...
from app_order.views import checkout, order_detail, order_list, update_order, update_order_items, update_order_status, print_check_non_fastfood, print_check_fastfood_only
